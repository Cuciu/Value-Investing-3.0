...
Years: int = 5
NBShares = 4
RealDiscountRate = 0.05
AverageInflation = 0.03
NominalDiscountRate = 0.08
...
def login():
   if request.method == 'POST':
       ...
       print(CurrentLiabilitiesCash_Factor0)
       ...
       print(AllLiabilitiesAssets_Factor0)
       ...
       print("Price 5 years ago was {}".format(Price5Years))
